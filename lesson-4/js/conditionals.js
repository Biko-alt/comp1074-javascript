...
output.textContent = `I get ${breakDuration} minutes of break time.`;
...
function setWeather() {
	...
	if (choice === 'sunny') {
		...
		icon.setAttribute('src', 'images/unknown.svg');
	}
	setBackgroundColour();
...
switch (speed) {
	...
	case 0:
		// 0 km/h
		windComment.textContent = speed + 'km/h - It is calm out there.';
	default:
		windComment.textContent = speed + 'km/h - That is an unusual wind speed!';
	}
...
coffeeBreak == true ? breakMessage = "Coffee time!" : breakMessage = "No break for you!";
textContent = "Keep working!";
